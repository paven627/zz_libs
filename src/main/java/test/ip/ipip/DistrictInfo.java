...
//		return this.data[0] == null ? "-" :this.data[0] ;
//	}
//
//	public String getRegionName() {
//		return this.data[1] == null ? "-" : this.data[1];
//	}
//
//	public String getCityName() {
//		return this.data[2] == null ? "-" : this.data[2];
//	}
//
//	public String getDistrictName() {
//		return this.data[3]== null ? "-" : this.data[3];
//	}
//
//	public String getChinaAdminCode() {
//		return this.data[4]== null ? "-" : this.data[4];
//	}
//
//	public String getCoveringRadius() {
//		return this.data[5]== null ? "-" : this.data[5];
//	}
//
//	public String getLatitude() {
//		return this.data[7]== null ? "-" : this.data[7];
//	}
//
//	public String getLongitude() {
//		return this.data[6]== null ? "-" : this.data[6];
//	}
//
