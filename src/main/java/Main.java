...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		String stamp = "2017-11-22T02%3A25%3A58Z";
		String string_to_sign = "GET\n" + 
				"/api_v2/medias/1982/reports/ies\n" + 
				"app_key=2fb4e1d&date=2017-11-20&maxResults=1&pubId=PUB_10009964&signature_method=HmacSHA256&signature_version=1&startIndex=0&timestamp="
				+ stamp;
		...
		String signatureBase64 = Codec.encryptBASE64(signatureBytes).replaceAll("\\n", "");
